...
def find_unusual_characters(plain_output: bool) -> int:
	...
	parser = argparse.ArgumentParser(description="Find characters outside a nominal expected range in a set of XHTML files. This can be useful to find transcription mistakes and mojibake.", prog="[command]sach[/] [subcommand]find-unusual-characters[/]", formatter_class=SachHelpFormatter)
