...
def find_mismatched_dashes(plain_output: bool) -> int:
	...
	parser = argparse.ArgumentParser(description="Find words with mismatched dashes in a set of XHTML files. For example, [text]extra-physical[/] in one file and [text]extraphysical[/] in another.", prog="[command]sach[/] [subcommand]find-mismatched-dashes[/]", formatter_class=SachHelpFormatter)
