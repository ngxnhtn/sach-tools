...
def css_select(plain_output: bool) -> int:
	...
	parser = argparse.ArgumentParser(description="Print the results of a CSS selector evaluated against a set of XHTML files.", prog="[command]sach[/] [subcommand]css-select[/]", formatter_class=SachHelpFormatter)
