...
class Browser:
	...
	def __init__(self):
		...
		try:
			...
			raise sach.MissingDependencyException(f"Couldn’t find web browser. Message: {ex}")

		raise sach.MissingDependencyException("Couldn’t find [command]chrome[/], [command]chromium[/], or [command]firefox[/].")
	...
	def driver(self) -> WebDriver:
		...
		if self._driver is None:
			try:
				...
				raise sach.MissingDependencyException(f"Couldn’t start web browser. Message: {ex}")
